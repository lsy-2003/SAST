...
def get_config():
    ...
    parser.add_argument(
        ...
        help='Number of consecutive evaluations without improvement to trigger early stopping. 0 to disable'
        )
    parser.add_argument(
        '--prompt_template',
        type=str,
        default=None,
        help='Custom prompt template for text encoder initialization (e.g., "a texture of a").'
    )
    parser.add_argument(
        '--per_class_prompts_path',
        type=str,
        default=None,
        help='Path to a text file defining per-class custom prompts.'
    )
    """
